...
class DocumentIngestion:
    ...
    def clean_old_sessions(self, keep_latest:int=3):
        """
        Deletes all files in the base directory.
        """
        try:
            ...
            self.log.error(f"Error deleting existing files:", error=str(e))
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        ...
        try:
            ...
            self.log.error("Error saving uploaded file:",error=str(e), session=self.session_id )
    ...
    def read_pdf(self, pdf_path:Path)->str:
        ...
        try:
            ...
            self.log.error("Error reading PDF : ", file=str(pdf_path), pages=len(all_text))
    ...
    def combine_documents(self)->str:
        try:
            ...
            self.log.error(f"Error in combining documents :", error=str(e), session=self.session_id)
            raise DocumentPortalException("An error ocurred while combining documents.", sys)
