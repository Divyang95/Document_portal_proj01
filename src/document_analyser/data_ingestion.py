...
if __name__ == "__main__":
    ...
    pdf_path = r"D:\LLMOPS_Krishnaik\Document_portal_proj01\data\document_analysis\NIPS-2017-attention-is-all-you-need-Paper.pdf.pdf"
    ...
    class DummyFile:
        ...
        def getbuffer(self):
            ...
            with open(self._file_path, "rb") as f:
                return BytesIO(f.read()).getbuffer()
